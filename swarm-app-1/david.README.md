...
docker service create --name vote --replicas 3 --publish 80:80 --network frontend dockersamples/examplevotingapp_vote:before
...
- result
    ...
    - on backend network
    - 1 replica
 docker service create --name result --replicas 1 --network backend --publish 5001:80 dockersamples/examplevotingapp_result:before
